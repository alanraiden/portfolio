...
const addressData = [
  ...
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "alansarang21@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "00-000 00000",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                Let’s collaborate to build something amazing in the cloud.
                Whether it’s AWS deployment, monitoring setup, or automation — I’d love to help.
              </p>
            </div>
